...
public class ConexaoBancoDeDados {
	...
	public static ConexaoBancoDeDados getConexao() {
		if(CONEXAO == null) {
	...
	private EntityManagerFactory getFactory() {
		...
		properties.put("hibernate.connection.url", "jdbc:mysql://localhost:3306/loja_informatica?createDatabaseIfNotExist=true&&useSSL=false");
